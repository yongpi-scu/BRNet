...
__all__ = ['InceptionResNetV2BRNet']
...
class InceptionResNetV2BRNet(nn.Module):
    def __init__(self, num_classes=1001, color_channels=3, **kwargs):
        super(InceptionResNetV2BRNet, self).__init__()
        self.conv2d_1a = MultiScale(color_channels, 32)
