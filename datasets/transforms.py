...
class Multi_Input(object):
    ...
    def __call__(self,img):
        ...
        img = np.stack([left_img,right_img,resized_img],axis=-1)
        # img = np.stack([resized_img,resized_img,resized_img],axis=-1)
        # img = np.stack([left_img,center_img,right_img,resized_img],axis=-1)
        # img = np.stack([left_img,center_img,right_img],axis=-1)
        return img